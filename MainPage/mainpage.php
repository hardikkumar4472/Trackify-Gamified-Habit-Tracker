    ...
    <header id="header" class="sticky top-0 z-50">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="space-x-4 flex items-center">
                <span class="text-white">Welcome, <?php echo htmlspecialchars($user_firstname); ?></span>
    ...
    <main class="container mx-auto px-4 md:px-10 py-6 fade-in">
        ...
        <section class="mt-16 fade-in" id="features">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 fade-in">
                ...
                <div class="bg-gray-600 p-6 transition-colors fade-in duration-400 ease-in-out rounded-[50px] border-2 border-white cursor-pointer hover:bg-gray-900 hover:rounded-[30px] hover:transition-transform hover:duration-500 hover:transform hover:scale-105">
                <a href="../XpandLevels/xpandlevels.php">
                ...
                <div class="bg-gray-600 p-6 transition-colors fade-in duration-400 ease-in-out rounded-[50px] border-2 border-white cursor-pointer hover:bg-gray-900 hover:rounded-[30px] hover:transition-transform hover:duration-500 hover:transform hover:scale-105">
                <a href="../Games/HabitCollector.html">
                    <img alt="XP icon" class="mx-auto mb-4 transition-transform transform hover:scale-110" src="static/trash-collector.png" width="60"/>
                    <h3 class="text-xl font-semibold text-orange-500 mb-2">Habit Collector Game</h3>
                    <p class="text-green-400">Completing this game earns XP</p>
                </a>
                </div>
                <div class="bg-gray-600 p-6 transition-colors fade-in duration-400 ease-in-out rounded-[50px] border-2 border-white cursor-pointer hover:bg-gray-900 hover:rounded-[30px] hover:transition-transform hover:duration-500 hover:transform hover:scale-105">
                <a href="../Games/HabitMatching.html">
                    <img alt="XP icon" class="mx-auto mb-4 transition-transform transform hover:scale-110" src="static/puzzle.png" width="60"/>
                    <h3 class="text-xl font-semibold text-orange-500 mb-2">Habit Matching Game</h3>
                    <p class="text-green-400">Completing this game earns XP</p>
                </a>
                </div>
                <div class="bg-gray-600 p-6 transition-colors fade-in duration-400 ease-in-out rounded-[50px] border-2 border-white cursor-pointer hover:bg-gray-900 hover:rounded-[30px] hover:transition-transform hover:duration-500 hover:transform hover:scale-105">
                <a href="../Games/HabitSlotMachine.html">
                    <img alt="XP icon" class="mx-auto mb-4 transition-transform transform hover:scale-110" src="static/slot-machine.png" width="60"/>
                    <h3 class="text-xl font-semibold text-orange-500 mb-2">Habit Slot Machine Game</h3>
                    <p class="text-green-400">Completing this game earns XP</p>
                </a>
                </div>
                <div class="bg-gray-600 p-6 transition-colors fade-in duration-400 ease-in-out rounded-[50px] border-2 border-white cursor-pointer hover:bg-gray-900 hover:rounded-[30px] hover:transition-transform hover:duration-500 hover:transform hover:scale-105">
                <a href="../Games/HabitPuzzle.html">
                    <img alt="XP icon" class="mx-auto mb-4 transition-transform transform hover:scale-110" src="static/jigsaw.png" width="60"/>
                    <h3 class="text-xl font-semibold text-orange-500 mb-2">Habit Puzzle Game</h3>
                    <p class="text-green-400">Completing this game earns XP</p>
                </a>
                </div>
                <div class="bg-gray-600 p-6 transition-colors fade-in duration-400 ease-in-out rounded-[50px] border-2 border-white cursor-pointer hover:bg-gray-900 hover:rounded-[30px] hover:transition-transform hover:duration-500 hover:transform hover:scale-105">
                <a href="../Games/MystryBox.html">
                    <img alt="XP icon" class="mx-auto mb-4 transition-transform transform hover:scale-110" src="../MainPage/static/mystery.png" width="60"/>
                    <h3 class="text-xl font-semibold text-orange-500 mb-2">Mystry Box Puzzle</h3>
                    <p class="text-green-400">Unlock New Rewards</p>
                </a>
                </div>
                <!-- <div class="bg-gray-600 p-6 transition-colors fade-in duration-400 ease-in-out rounded-[50px] border-2 border-white cursor-pointer hover:bg-gray-900 hover:rounded-[30px] hover:transition-transform hover:duration-500 hover:transform hover:scale-105">
        ...
        <section class="mt-16 fade-in" id="topics">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                ...
                <div class="cursor-pointer border-2 fade-in border-white bg-gray-600 p-5 rounded-[20px] shadow-md hover:bg-gray-900 hover:shadow-lg transition-transform transform hover:scale-105 hover:bg-blue-50 duration-2000 fade-in">
                    <a href="../Help_Topics/Webpages/Exercise/jogging.html">
                ...
                <div class="cursor-pointer border-2 fade-in border-white bg-gray-600 p-5 rounded-[20px] shadow-md hover:bg-gray-900 hover:shadow-lg transition-transform transform hover:scale-105 hover:bg-blue-50 duration-2000 fade-in">
                    <a href="../Help_Topics/Webpages/books/directory.html">
                ...
                <div class="cursor-pointer border-2 fade-in border-white bg-gray-600 p-5 rounded-[20px] shadow-md hover:bg-gray-900 hover:shadow-lg transition-transform transform hover:scale-105 hover:bg-blue-50 duration-2000 fade-in">
                    <a href="../Help_Topics/Webpages/PracticeGratitude/index.php">
                ...
                <div class="cursor-pointer border-2 fade-in border-white bg-gray-600 p-5 rounded-[20px] shadow-md hover:bg-gray-900 hover:shadow-lg transition-transform transform hover:scale-105 hover:bg-blue-50 duration-2000 fade-in">
                    <a href="../Help_Topics/Webpages/LimitScreenTime/index.php">
                ...
                <div class="cursor-pointer border-2 fade-in border-white bg-gray-600 p-5 rounded-[20px] shadow-md hover:bg-gray-900 hover:shadow-lg transition-transform transform hover:scale-105 hover:bg-blue-50 duration-2000 fade-in">
                    <a href="../Help_Topics/Webpages/StayHydrated/StayHydrated.php">
                ...
                <div class="cursor-pointer border-2 fade-in border-white bg-gray-600 p-5 rounded-[20px] shadow-md hover:bg-gray-900 hover:shadow-lg transition-transform transform hover:scale-105 hover:bg-blue-50 duration-2000 fade-in">
                    <a href="../Help_Topics/Webpages/SleepWell/SleepWell.php">
                ...
                <div class="cursor-pointer border-2 fade-in border-white bg-gray-600 p-5 rounded-[20px] shadow-md hover:bg-gray-900 hover:shadow-lg transition-transform transform hover:scale-105 hover:bg-blue-50 duration-2000 fade-in">
                    <a href="../Help_Topics/Webpages/KeepLearning/KeepLearning.php">
